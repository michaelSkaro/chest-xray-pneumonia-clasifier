...
# - [ ] The pneumonia samples can be further broken down into viral and bacterial groups. The information is in the filename.
...
# %% [markdown]
# First we check the number of samples under each data category (normal vs. pneumonia). The test set is roughly 10% of the entire dataset. Two obvious problems:
#
